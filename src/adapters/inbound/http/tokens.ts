...
export const GET_CANONICAL_PRODUCT_BY_REFERENCE = Symbol('GetCanonicalProductByReference')
export const LOOKUP_CANONICAL_PRODUCTS = Symbol('LookupCanonicalProducts')
...
export const CONFIGURE_PRODUCT_PREMIUM = Symbol('ConfigureProductPremium')
export const ACQUIRE_PRODUCT_UNIT = Symbol('AcquireProductUnit')
export const GET_CANONICAL_PRODUCT = Symbol('GetCanonicalProduct')
export const GET_OFFICIAL_AUCTION_ELIGIBILITY = Symbol('GetOfficialAuctionEligibility')
