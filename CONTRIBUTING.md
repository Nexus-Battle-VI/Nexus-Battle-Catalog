# Contribución a Nexus-Battle-Catalog
...
fix/bug-12-filtrado-categoria
chore/bootstrap-sprint1-foundation
ci/cache-dependencias
docs/contrato-openapi
test/cobertura-publicacion
refactor/politica-de-precios
```
...
fix(catalog): [BUG-12] corregir el filtrado por categoria
```
